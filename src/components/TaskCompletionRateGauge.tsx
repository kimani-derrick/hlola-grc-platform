...
interface TaskCompletionRateGaugeProps {
...
export default function TaskCompletionRateGauge({ 
  completionRate, 
  totalTasks,
  completedTasks,
  title: _title, 
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      setAnimatedValue(completionRate);
    }, 500);
  ...
  return (
    <div className="relative flex flex-col items-center">
      ...
      <div className="mt-8 text-center">
        <div className="text-sm font-bold text-gray-800 mb-1">Task Completion Rate</div>
        <div className="flex items-center justify-center gap-1">
          ...
          <span className="text-xs font-medium text-gray-600">
            {status === 'critical' ? 'Behind Schedule' : 
             status === 'warning' ? 'On Track' : 'Ahead of Schedule'}
          </span>
        </div>
      </div>
      ...
      <div className="mt-4 flex justify-between items-center text-xs">
        ...
        <div className="text-center flex-1">
          <div className="font-bold text-gray-800">{totalTasks}</div>
        ...
        <div className="w-px h-8 bg-gray-300 mx-2"></div>
        <div className="text-center flex-1">
          <div className="font-bold text-orange-600">{totalTasks - completedTasks}</div>
