...
const createFrameworkSchema = Joi.object({
  ...
  maxFineAmount: Joi.string().optional().allow('').default('0'),
  maxFineCurrency: Joi.string().max(10).optional().default('EUR')
});
...
const createTaskSchema = Joi.object({
  ...
  autoGenerated: Joi.boolean().optional().default(false)
});
